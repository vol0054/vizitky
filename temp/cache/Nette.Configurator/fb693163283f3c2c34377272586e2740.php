<?php
// source: /var/www/html/vizitky/app/config/config.neon 
// source: /var/www/html/vizitky/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\model\\cardmodel' => array('23_App_Model_CardModel'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/vizitky/app',
			'wwwDir' => '/var/www/html/vizitky/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/html/vizitky/app/../temp',
		));
	}


	/**
	 * @return App\Model\CardModel
	 */
	public function createService__23_App_Model_CardModel()
	{
		$service = new App\Model\CardModel($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/vizitky/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=vizitky', 'root', NULL, array('lazy' => TRUE));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/vizitky/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/html/vizitky/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/html/vizitky/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/html/vizitky/app/../temp/cache', $this->getService('nette.cacheJournal'));
